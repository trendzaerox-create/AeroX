  ...
  return (
    <section className="relative overflow-hidden border-b border-neutral-200 bg-white">
      ...
      <div className="relative mx-auto grid max-w-[1280px] grid-cols-1 gap-8 px-4 py-10 sm:px-6 sm:py-14 lg:grid-cols-2 lg:gap-12 lg:px-10 lg:py-16">
        ...
        <div className="grid grid-cols-2 gap-4 sm:gap-5">
          {/* MAIN IMAGE */}
          <div className="group relative h-[280px] overflow-hidden rounded-[24px] bg-[#f6f6f6] sm:h-[420px] lg:h-[520px]">
            <Image
              src="/images/8.png"
              alt="Trendz Firenze handbag"
              fill
          ...
          <div className="flex flex-col gap-4 sm:gap-5">
            {/* SMALL IMAGE */}
            <div className="group relative h-[132px] overflow-hidden rounded-[24px] bg-[#f3f3f3] sm:h-[198px] lg:h-[248px]">
              <Image
                src="/images/2.png"
                alt="Premium handbag"
                fill
