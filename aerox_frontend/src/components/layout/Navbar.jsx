    ...
    <header className="sticky top-0 z-[1000] w-full bg-black">
      ...
      >
        <div className="flex items-center gap-2 lg:gap-5">
          ...
          >
           <span className="relative flex h-[48px] w-[90px] items-center justify-center sm:h-[54px] sm:w-[110px]">
  <img
    src="/images/logo/TrendzAeroXLogo-navbar.webp"
    alt="Trendz AeroX"
    className="h-full w-full object-contain transition-all duration-500 ease-out group-hover:scale-105 group-hover:opacity-90"
  />
</span>
          </Link>
        </div>
